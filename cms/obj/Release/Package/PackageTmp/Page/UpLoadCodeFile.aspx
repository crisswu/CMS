<%@ Page Title="" Language="C#" MasterPageFile="~/Master/PageMaster.Master" AutoEventWireup="true" CodeBehind="UpLoadCodeFile.aspx.cs" Inherits="CMS.Page.UpLoadCodeFile" %>
    ...
    <script>
        ...
        function LoadTable()
        {
            ...
            $.ajax({
                ...
                data: { funType: "GetCodeFiles", Type: $("#ddlType").val() },
                success: function (result) {
                    ...
                    if (result != "") {
                        ...
                        for (var i = 0; i < dt.Notes.length; i++) {
                            ...
                            if ($("#ddlType").val() == "" || dt.Notes[i].FileType == $("#ddlType").val()) {
                                html += "<tr><td><a href=\"#\" onclick=\"deleteFile('" + dt.Notes[i].FileName + "');\" >删除</a></td><td><a href='FileDownload.aspx?FilesName=" + dt.Notes[i].FileName + "'  id=\"AID" + i + "\" target=\"_blank\" >" + dt.Notes[i].FileName + "</a></td><td>" + dt.Notes[i].FileSize + "</td></tr>";
                            }
                        }
                        html += "</tbody>";
                        MyThree.html(html);
            ...
            x0p({
                ...
                if (button == "info") {
                    $.ajax({
                        type: "Get",
                        url: "/ashx/UploadQiniu.ashx",
                        data: { funType: "DeleteCodeFile", FileName:FileName },
                        success: function (result) {
                                    ...
                                    <tr>
                                        ...
                                        <td style=" width:250px">
                                         ...
                                         <td  style=" width:170px">
                                            <button class="button button--antiman button--text-thick button--text-upper button--size-s button--inverted-alt button--round-s button--border-thick" onclick="return LoadTable();" style=" padding-top: 10px; height: 40px;color: #CCC5B9"><i class="ti-zoom-in"></i><span>搜索</span></button>
                                        </td>
...
<%--                                <div class="footer" style="padding-top: 20px;">
       ...
       <script>
        ...
        var uploader = new plupload.Uploader({
            ...
            url: '/ashx/UploadQiniu.ashx?funType=UploadCodeFile', //服务器端的上传页面地址
