<%@ Page Title="" Language="C#" MasterPageFile="~/Master/PageMaster.Master" AutoEventWireup="true" ValidateRequest="false" CodeBehind="Memory.aspx.cs" Inherits="CMS.Page.Memory" %>
    ...
    <script>
        ...
        function OpenIndexedDB(name, version) {
            ...
            request.onsuccess = function (e) {
                ...
                getDataByIndex(myDB.db, "TreeTable");
            };
         ...
         function LoadFive()
         {
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    MyThree.html(html);
                    Trees.Content = html;
                    saveTreeData(myDB.name, myDB.version, "TreeTable", Trees);
                    MymtreeClick(jQuery, this, this.document);//加载 li点击事件  在  Mymtree.js中
                    ...
                    if (result != "") {
                        ...
                        for (var i = 0; i < dt.Notes.length; i++) {
                            ...
                            if (dt.Notes[i].Type == "2")// 类型为2 是 内容页  其他为父节点
                            {
                                ...
                                html += "<li><a href=\"#\"  onclick=\"SetID('" + dt.Notes[i].ID + "')\"   >" + "<span class=\"glyphicon glyphicon-circle-arrow-down\"></span>&emsp;" + HtmlFilter(dt.Notes[i].Name) + "</a><ul>";
                                html = LoadDG(dt.Notes[i].ID, html);
                                html += "</ul></li>";
                            }
                        }
